...
# Run 'Before Experiment' code from rec_code
...
expInfo = {
    'Participante': f"{randint(0, 999999):06.0f}",
    'COM': list(range(1,25)),
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\agust\\OneDrive\\Desktop\\CNC\\Paradigmas\\Python\\Rutvik\\picture-naming\\picture-naming_lastrun.py',
...
def run(expInfo, thisExp, win, inputs, globalClock=None, thisSession=None):
    ...
    image = visual.ImageStim(
        ...
        flipHoriz=False, flipVert=False,
        texRes=128.0, interpolate=True, depth=0.0)
    # Run 'Begin Experiment' code from rec_code
    ...
    for thisTrial_2 in trials_2:
        ...
        for thisTrials_practice in trials_practice:
            ...
            # keep track of which components have finished
            stim_practiceComponents = [practice_image]
        ...
        for thisTrial in trials:
            ...
            while continueRoutine and routineTimer.getTime() < 4.5:
                ...
                # Run 'Each Frame' code from rec_code
                recorder.stop_recording()
